...
export const works: WorkItem[] = [
  ...
  },
  {
    ...
    vertical: 'infoproducts',
    description:
      'HTTPS retention curve on the VTurb report (middle graph) — 47.61% retention on a 22:51 video · 1,526 views · 658 plays.',
    driveFileId: '',
    localPreviewUrl: '/proof/application-page-2.png',
    thumbnail: '/proof/application-page-2.png',
    featured: true,
  ...
  },
  {
    ...
    vertical: 'telehealth',
    description:
      'Long-form paid social scripts for telehealth — the format scaling in this market.',
